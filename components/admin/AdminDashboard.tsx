...
import type { AdminAnalyticsType } from '@/lib/admin-service'
...
export const AdminDashboard = ({
	...
	analyticsPromise: Promise<AdminAnalyticsType>
}) => {
				...
				<Card className="p-8 max-w-md w-full shadow-lg">
					<div className="text-center">
						...
						<p className="text-gray-600 mb-6">
							...
							dashboard. Only administrators can view this page.
						</p>
						<Link href={'/dashboard'}>
			...
			<div className="max-w-7xl mx-auto px-4">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600">
						Manage users, monitor app performance, and view detailed
						analytics
					</p>
				</div>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-orange-600">
										{formatNumber(
											analytics.activeUsersLast7Days,
										)}{' '}
										this week
									</p>
								</div>
						...
						<CardContent className="p-6">
							...
							<div className="space-y-3">
								<div className="flex items-center justify-between">
									...
									<span className="font-semibold">
										{formatNumber(
											analytics.invoicesCreatedThisWeek,
										)}
									</span>
								</div>
								<div className="flex items-center justify-between">
								...
								<div className="flex items-center justify-between">
									...
									<span className="font-semibold">
										{analytics.avgInvoicesPerUser.toFixed(
											1,
										)}
									</span>
								</div>
						...
						<CardContent className="p-6">
							...
							<div className="space-y-3">
								...
								<div className="flex items-center justify-between">
									...
									<span className="font-semibold">
										{formatNumber(
											analytics.invoicesCreatedThisMonth,
										)}
									</span>
								</div>
								<div className="flex items-center justify-between">
