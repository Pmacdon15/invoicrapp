			...
			<div className="container mx-auto max-w-7xl relative z-10">
              ...
              don't lose time */}
						...
						<p className="text-xl lg:text-lg xl:text-xl text-emerald-100 mb-8 lg:max-w-lg leading-relaxed">
							Streamline your billing process with our intuitive
							invoice generator. Create professional invoices in
							minutes, manage clients effortlessly, and get paid
