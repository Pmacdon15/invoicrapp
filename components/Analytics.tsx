...
import type { InvoiceAnalytics } from '@/lib/invoice-service'
import SetPeriodButtons from './analytics/set-period-buttons'
...
export const Analytics = ({
	...
	analyticsPromise: Promise<InvoiceAnalytics>
	periodPromise: Promise<'30days' | '6months' | '1year'>
}) => {
	...
	return (
		<div className="space-y-6">
			...
			<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
				...
				<Suspense>
					<SetPeriodButtons selectedPeriodPromise={periodPromise} />
				</Suspense>
			</div>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						{analytics.statusBreakdown.map((status) => (
							<div className="space-y-2" key={status.status}>
								<div className="flex items-center justify-between">
